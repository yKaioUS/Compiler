    ...
    uploadForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                updateResult('syntax-tree-result', result.syntax_tree || '无结果');
                updateResult('ll-analysis-result', result.ll_analysis || '无结果');
                updateResult('lr-analysis-result', result.lr_analysis || '无结果');
